...
class DiabeticRetinopathyData(DataLoader):
    def __init__(self, path='data/messidor_features.arff', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def data_name(self):
        return 'DiabeticRetinopathyData'
...
if __name__ == '__main__':
    ...
    dr_data = DiabeticRetinopathyData(verbose=True)
    dr_data.load_and_process()

    qs_data = QSARData(verbose=True)
    qs_data.load_and_process()
