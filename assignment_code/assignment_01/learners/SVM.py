...
class SVMLearner(learners.BaseLearner):
    def __init__(self, C=2.251, kernel='rbf', degree=3, gamma=0.024390243902439025,
                 coef0=0.0, shrinking=True, probability=False,
                 tol=0.04000001, cache_size=200, class_weight='balanced',
...
class LinearSVMLearner(learners.BaseLearner):
    def __init__(self, C=2.251, loss='squared_hinge', dual=False, penalty='l2',
                 multi_class='ovr', intercept_scaling=1, fit_intercept=True,
                 tol=0.09000000999999999, class_weight='balanced',
                 verbose=False, max_iter=1185, random_state=None):
        super().__init__(verbose)
